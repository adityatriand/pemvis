...
<head>
    ...
    <title>Landing | Pemrograman Visual Reguler</title>
    ...
    <div class="wrapper">
        ...
        <header class="main-header">
            ...
            <a href="<?= base_url('template/') ?>index2.html" class="logo">
                ...
                <span class="logo-mini"><b>P</b>VIS</span>
                <!-- logo for regular state and mobile devices -->
                <span class="logo-lg"><b>PEM</b>VIS</span>
            </a>
                    ...
                    <section class="col-lg-7 connectedSortable">
                        ...
                        <div class="box box-success">
                            ...
                            <div class="box-body chat" id="chat-box">
                                <!-- chat item -->
                                <div class="item">
                                    <img src="<?= base_url('template/') ?>dist/img/user4-128x128.jpg" alt="user image" class="online">
                                ...
                                <!-- chat item -->
                                <div class="item">
                                    <img src="<?= base_url('template/') ?>dist/img/user3-128x128.jpg" alt="user image" class="offline">
                                ...
                                <!-- chat item -->
                                <div class="item">
                                    <img src="<?= base_url('template/') ?>dist/img/user2-160x160.jpg" alt="user image" class="offline">
